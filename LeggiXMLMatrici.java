...
public class LeggiXMLMatrici {
	private static ArrayList<CittaMatrici> listaCitta = new ArrayList<CittaMatrici>();
	        ...
	        while(xmlr.hasNext()) {
	            ...
	            case XMLStreamConstants.START_ELEMENT:{
		            if(xmlr.getLocalName().equals("city")) {
		            	listaCitta.add(new CittaMatrici()); //gli aggiungo una città vuota	
	...
	//quali città hai letto?
		public ArrayList<CittaMatrici> getListaCitta(){
			return listaCitta;
		}
		
		public static CittaMatrici getCittaFromId (int id) {
